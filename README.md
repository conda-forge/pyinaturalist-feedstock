...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyinaturalist-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12568&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyinaturalist-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyinaturalist` can be installed with:

```
conda install pyinaturalist
```

It is possible to list all of the versions of `pyinaturalist` available on your platform with:
